                    ...
                    <ul class="list-unstyled">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar4.jpg ') }}" alt="">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar5.jpg ') }}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar2.jpg ') }}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar1.jpg ') }}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar3.jpg ') }}" alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar10.jpg ') }}" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar6.jpg ') }}" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar7.jpg ') }}" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar8.jpg ') }}" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{asset('assets/frontend/assets/images/xs/avatar9.jpg ') }}" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('assets/frontend/assets/images/xs/avatar4.jpg ') }}" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('assets/frontend/assets/images/xs/avatar5.jpg ') }}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('assets/frontend/assets/images/xs/avatar6.jpg ') }}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('assets/frontend/assets/images/xs/avatar7.jpg ') }}" alt="">
                            <div class="sl-content">
