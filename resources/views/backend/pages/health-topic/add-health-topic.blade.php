...
<section style="padding-top: 100px;">
    <div class="container">
        ...
        <div class="card col-md-6">
            ...
            <div class="card-body">
                <form action="{{url('store-health-topic')}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label >Health Topic Name</label>
                        <input type="text" autocomplete="off" class="form-control" id="health_topic_name" name="health_topic_name" placeholder="Enter health-topic">
