...
<section style="padding-top: 100px;">
    <div class="container">
        ...
        <div class="card col-md-12">
            ...
            <div class="card-body" >
                <form class="form" action="{{route('admin.store-sub-health-speech', $id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="" name="sub_hs_title" placeholder="Enter Health Speech Topic">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="sub_hs_description" style="height: 300px;" class="text_editor"></textarea>
                        </div>
                        <div class="form-group">
                            <label ><b>Summery Of Topics</b></label>
                            <textarea name="summery_of_topics" style="height: 300px;" class="text_editor"></textarea>
                        </div>
                    </div>
